...
public class Main {
    ...
    private final static String[] DEFAULT_POSITIONS = new String[]{
    ...
    public static void main(String[] args) {
        final var seed = (args == null || args.length == 0) ? DEFAULT_POSITIONS : args;
        final var positions = Stream.of(seed)
                .collect(toMap(
                        k -> k.split(";")[0],
                        v -> v.split(";")[1]
                ));
